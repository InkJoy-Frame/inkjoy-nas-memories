...
const I18N = {
  en: {
    ...
    'home.albums.new':         '+ New Playback',
    'home.albums.empty':       'No playback yet. Click "+ New Playback" above to get started.',
    ...
    'qp.folder.empty':         'Empty folder',
    'qp.source.hint':          'Select an album above or browse folders',
    'qp.source.browse':        '📂 Browse Folders',
    'qp.zoom.hint':            '💡 Scroll to zoom, drag to position. Zoom out for frosted glass fill.',
    'qp.rotate':               'Rotate',
    'qp.push':                 'Push to Frame',
    'qp.push.sending':         'Sending {n}/{total}…',
    'qp.push.success':         'Sent!',
    'qp.push.partial':         '{ok} sent, {fail} failed',
    'qp.push.allFail':         'All failed',
    ...
    /* ── Binding ──────────────────────────────── */
    'bind.th.time':            'Time',
    'bind.th.effect':          'Effect',
    'bind.th.next':            'Next push',
    'bind.add':                '+ Add Frame',
    'bind.addTime':            '+ Add schedule',
    'bind.addTime.title':      'Add Schedule',
  ...
  zh: {
    ...
    'home.albums.new':         '+ 新建播放',
    'home.albums.empty':       '还没有自动播放，点击右上角「+ 新建播放」开始',
    'home.push.title':         '快速推送',
    'home.push.subtitle':      '临时推一张照片到相框，不走定时任务',
    'home.push.browse':        '浏览并推送',
    'qp.folder.empty':         '空文件夹',
    'qp.source.hint':          '选择上方的相册或浏览文件夹',
    'qp.source.browse':        '📂 浏览文件夹',
    'qp.zoom.hint':            '💡 滚轮缩放、拖动构图。缩小到边界以外时自动毛玻璃填充',
    'qp.rotate':               '旋转',
    'qp.push':                 '推送到相框',
    'qp.push.sending':         '正在推送 {n}/{total}…',
    'qp.push.success':         '推送成功！',
    'qp.push.partial':         '{ok} 台成功，{fail} 台失败',
    'qp.push.allFail':         '全部推送失败',
    'qp.noDevice':             '未找到相框',
    'qp.reselect':             '重新选择',
